...
public class CompanyRandom implements RandomData<String> {

    @Override
    public String next() {
        String companyPrefixs = RandomUtils.selectOneInArray(companyPrefix);
        String companySuffixs = RandomUtils.selectOneInArray(companySuffix);

        return companyPrefixs + companySuffixs;
    }

    private static final  String[] companyPrefix = {
            "超艺", "和泰", "九方", "鑫博腾飞", "戴硕电子",
    ...
    private static final String[] catchPhrase = {
            "燕舞，燕舞，一曲歌来一片情。",
            "康师傅方便面，好吃看得见。",
            "不要太潇洒！",
            "让一亿人先聪明起来。",
